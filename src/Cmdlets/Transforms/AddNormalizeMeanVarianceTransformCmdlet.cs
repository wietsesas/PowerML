...
namespace PowerML.Cmdlets
{
    ...
    [Cmdlet(VerbsCommon.Add, "NormalizeMeanVarianceTransform", ConfirmImpact = ConfirmImpact.Low, SupportsShouldProcess = true)]
    [OutputType(typeof(EstimatorChain<ITransformer>))]
    public sealed class AddNormalizeMeanVarianceTransformCmdlet : EstimatorChainCmdlet
    {
        /// <summary>
        ...
        [Parameter()]
        [PSDefaultValue(Value = false)]
        public SwitchParameter UseCdf { get; set; }
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ShouldProcess($"Add a NormalizeMeanVarianceTransform", $"Are you sure you want to add a NormalizeMeanVarianceTransform?", "PowerML"))
                return;

            // Create the estimator
            IEstimator<ITransformer> estimator = Context!.Transforms.NormalizeMeanVariance(OutputColumn, InputColumn, MaxExamples, !DontFixZero, UseCdf);
