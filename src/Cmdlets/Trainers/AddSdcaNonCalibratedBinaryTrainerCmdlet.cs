...
namespace PowerML.Cmdlets
{
    ...
    [Cmdlet(VerbsCommon.Add, "SdcaNonCalibratedBinaryTrainer", ConfirmImpact = ConfirmImpact.Low, SupportsShouldProcess = true)]
    [OutputType(typeof(EstimatorChain<ITransformer>))]
    public sealed class AddSdcaNonCalibratedBinaryTrainerCmdlet : EstimatorChainCmdlet
    {
        /// <summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ShouldProcess($"Add a SdcaNonCalibratedBinaryTrainer", $"Are you sure you want to add a SdcaNonCalibratedBinaryTrainer?", "PowerML"))
                return;

            // Create the estimator
            IEstimator<ITransformer> estimator = Context!.BinaryClassification.Trainers.SdcaNonCalibrated(LabelColumn, FeatureColumn, ExampleWeightColumn, LossFunction, L2Regularization, L1Regularization, MaxIterations);
