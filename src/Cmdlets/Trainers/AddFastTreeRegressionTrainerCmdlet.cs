...
namespace PowerML.Cmdlets
{
    ...
    [Cmdlet(VerbsCommon.Add, "FastTreeRegressionTrainer", ConfirmImpact = ConfirmImpact.Low, SupportsShouldProcess = true)]
    [OutputType(typeof(EstimatorChain<ITransformer>))]
    public sealed class AddFastTreeRegressionTrainerCmdlet : EstimatorChainCmdlet
    {
        /// <summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ShouldProcess($"Add a FastTreeRegressionTrainer", $"Are you sure you want to add a FastTreeRegressionTrainer?", "PowerML"))
                return;

            // Create the estimator
            IEstimator<ITransformer> estimator = Context!.Regression.Trainers.FastTree(LabelColumn, FeatureColumn, ExampleWeightColumn, Leaves, Trees, MinExampleCountPerLeaf, LearningRate);
