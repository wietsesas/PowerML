...
namespace PowerML.Cmdlets
{
    ...
    [Cmdlet(VerbsCommon.Add, "SgdNonCalibratedBinaryTrainer", ConfirmImpact = ConfirmImpact.Low, SupportsShouldProcess = true)]
    [OutputType(typeof(EstimatorChain<ITransformer>))]
    public sealed class AddSgdNonCalibratedBinaryTrainerCmdlet : EstimatorChainCmdlet
    {
        /// <summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ShouldProcess($"Add a SgdNonCalibratedBinaryTrainer", $"Are you sure you want to add a SgdNonCalibratedBinaryTrainer?", "PowerML"))
                return;

            // Create the estimator
            IEstimator<ITransformer> estimator = Context!.BinaryClassification.Trainers.SgdNonCalibrated(LabelColumn, FeatureColumn, ExampleWeightColumn, LossFunction, Iterations, LearningRate, L2Regularization);
