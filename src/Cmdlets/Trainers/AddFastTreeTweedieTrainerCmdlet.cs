...
namespace PowerML.Cmdlets
{
    ...
    [Cmdlet(VerbsCommon.Add, "FastTreeTweedieTrainer", ConfirmImpact = ConfirmImpact.Low, SupportsShouldProcess = true)]
    [OutputType(typeof(EstimatorChain<ITransformer>))]
    public sealed class AddFastTreeTweedieTrainerCmdlet : EstimatorChainCmdlet
    {
        /// <summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ShouldProcess($"Add a FastTreeTweedieTrainer", $"Are you sure you want to add a FastTreeTweedieTrainer?", "PowerML"))
                return;

            // Create the estimator
            IEstimator<ITransformer> estimator = Context!.Regression.Trainers.FastTreeTweedie(LabelColumn, FeatureColumn, ExampleWeightColumn, Leaves, Trees, MinExampleCountPerLeaf, LearningRate);
