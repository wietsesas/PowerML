...
namespace PowerML.Cmdlets
{
    ...
    [Cmdlet(VerbsCommon.Add, "LightGbmRankingTrainer", ConfirmImpact = ConfirmImpact.Low, SupportsShouldProcess = true)]
    [OutputType(typeof(EstimatorChain<ITransformer>))]
    public sealed class AddLightGbmRankingTrainerCmdlet : EstimatorChainCmdlet
    {
        /// <summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ShouldProcess($"Add a LightGbmRankingTrainer", $"Are you sure you want to add a LightGbmRankingTrainer?", "PowerML"))
                return;

            // Create the estimator
            IEstimator<ITransformer> estimator = Context!.Ranking.Trainers.LightGbm(LabelColumn, FeatureColumn, RowGroupColumn, ExampleWeightColumn, Leaves, MinExampleCountPerLeaf, LearningRate, Iterations);
