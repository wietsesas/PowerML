...
namespace PowerML.Cmdlets
{
    ...
    [Cmdlet(VerbsCommon.Add, "LbfgsPoissonRegressionTrainer", ConfirmImpact = ConfirmImpact.Low, SupportsShouldProcess = true)]
    [OutputType(typeof(EstimatorChain<ITransformer>))]
    public sealed class AddLbfgsPoissonRegressionTrainerCmdlet : EstimatorChainCmdlet
    {
        /// <summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ShouldProcess($"Add a LbfgsPoissonRegressionTrainer", $"Are you sure you want to add a LbfgsPoissonRegressionTrainer?", "PowerML"))
                return;

            // Create the estimator
            IEstimator<ITransformer> estimator = Context!.Regression.Trainers.LbfgsPoissonRegression(LabelColumn, FeatureColumn, ExampleWeightColumn, L1Regularization, L2Regularization, OptimizationTolerance, HistorySize, EnforceNonNegativity);
