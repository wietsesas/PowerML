...
namespace PowerML.Cmdlets
{
    ...
    [Cmdlet(VerbsCommon.Add, "LbfgsLogisticRegressionBinaryTrainer", ConfirmImpact = ConfirmImpact.Low, SupportsShouldProcess = true)]
    [OutputType(typeof(EstimatorChain<ITransformer>))]
    public sealed class AddLbfgsLogisticRegressionBinaryTrainerCmdlet : EstimatorChainCmdlet
    {
        /// <summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ShouldProcess($"Add a LbfgsLogisticRegressionBinaryTrainer", $"Are you sure you want to add a LbfgsLogisticRegressionBinaryTrainer?", "PowerML"))
                return;

            // Create the estimator
            IEstimator<ITransformer> estimator = Context!.BinaryClassification.Trainers.LbfgsLogisticRegression(LabelColumn, FeatureColumn, ExampleWeightColumn, L1Regularization, L2Regularization, OptimizationTolerance, HistorySize, EnforceNonNegativity);
