...
{
    /// <summary>
    /// Train a regression model with generalized additive models (GAM).
    /// </summary>
    /// <category order="50">Trainers</category>
    /// <inputtype name="Microsoft.ML.Data.EstimatorChain&lt;Microsoft.ML.ITransformer&gt;">You can pipe the EstimatorChain to append to this cmdlet.</inputtype>
    /// <outputtype name="Microsoft.ML.Data.EstimatorChain&lt;Microsoft.ML.ITransformer&gt;">This cmdlet returns the appended EstimatorChain.</outputtype>
    [Cmdlet(VerbsCommon.Add, "GamRegressionTrainer", ConfirmImpact = ConfirmImpact.Low, SupportsShouldProcess = true)]
    [OutputType(typeof(EstimatorChain<ITransformer>))]
    public sealed class AddGamRegressionTrainerCmdlet : EstimatorChainCmdlet
    {
        /// <summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ShouldProcess($"Add a GamRegressionTrainer", $"Are you sure you want to add a GamRegressionTrainer?", "PowerML"))
                return;

            // Create the estimator
            IEstimator<ITransformer> estimator = Context!.Regression.Trainers.Gam(LabelColumn, FeatureColumn, ExampleWeightColumn, Iterations, MaxBinCountPerFeature, LearningRate);
