...
namespace PowerML.Cmdlets
{
    ...
    [Cmdlet(VerbsCommon.Add, "FastTreeBinaryTrainer", ConfirmImpact = ConfirmImpact.Low, SupportsShouldProcess = true)]
    [OutputType(typeof(EstimatorChain<ITransformer>))]
    public sealed class AddFastTreeBinaryTrainerCmdlet : EstimatorChainCmdlet
    {
        /// <summary>
        ...
        protected override void ProcessRecord()
        {
            ...
            if (!ShouldProcess($"Add a FastTreeBinaryTrainer", $"Are you sure you want to add a FastTreeBinaryTrainer?", "PowerML"))
                return;

            // Create the estimator
            IEstimator<ITransformer> estimator = Context!.BinaryClassification.Trainers.FastTree(LabelColumn, FeatureColumn, ExampleWeightColumn, Leaves, Trees, MinExampleCountPerLeaf, LearningRate);
