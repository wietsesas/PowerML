...
```
Add-LoadImagesTransform [-OutputColumn] <String> [[-InputColumn] <String>] [-Path] <String> [-AppendTo <EstimatorChain<ITransformer>>] [-AppendScope <TransformerScope>] [-Context <MLContext>] [<CommonParameters>]
```
