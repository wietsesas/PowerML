...
```
Add-ConvertToGrayscaleTransform [-OutputColumn] <String> [[-InputColumn] <String>] [-AppendTo <EstimatorChain<ITransformer>>] [-AppendScope <TransformerScope>] [-Context <MLContext>] [<CommonParameters>]
```
