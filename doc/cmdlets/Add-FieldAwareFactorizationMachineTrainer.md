...
```
Add-FieldAwareFactorizationMachineTrainer [[-LabelColumn] <String>] [[-FeatureColumn] <String[]>] [[-ExampleWeightColumn] <String>] [-AppendTo <EstimatorChain<ITransformer>>] [-AppendScope <TransformerScope>] [-Context <MLContext>] [<CommonParameters>]
```
