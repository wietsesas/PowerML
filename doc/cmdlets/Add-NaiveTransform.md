...
```
Add-NaiveTransform [[-LabelColumn] <String>] [[-ScoreColumn] <String>] [-AppendTo <EstimatorChain<ITransformer>>] [-AppendScope <TransformerScope>] [-Context <MLContext>] [<CommonParameters>]
```
