...
```
Add-SymbolicSgdLogisticRegressionBinaryTrainer [[-LabelColumn] <String>] [[-FeatureColumn] <String>] [-Iterations <Int32>] [-AppendTo <EstimatorChain<ITransformer>>] [-AppendScope <TransformerScope>] [-Context <MLContext>] [<CommonParameters>]
```
